...
namespace ShareBill
{
    ...
    public class Application : MultitouchApplication
    {
        ...
        {
            // Load Contents
            this.fSmall = Font.CreateFont("Fonts/SmallFontMonospaced");
            this.fSmall.Sprite.Spacing = -15f;
            this.fLarge = Font.CreateFont("Fonts/LargeFontMonospaced");
            this.fLarge.Sprite.Spacing = -15f;
            this.padding = new Padding(0, 0, 150, 0);
            this.iApplicationBackground = Image.CreateImage("Images/appBackground");
            this.iMainContainerBackground = Image.CreateImage("Images/napkin");
            this.iPen = Image.CreateImage("Images/pen");
            this.iButtonPlusReleased = Image.CreateImage("Images/plusButtonReleased");
            this.iButtonPlusPressed = Image.CreateImage("Images/plusButtonPressed");
            this.iButtonMinusReleased = Image.CreateImage("Images/minusButtonReleased");
            this.iButtonMinusPressed = Image.CreateImage("Images/minusButtonPressed");
            this.writingPlayer = Sound.CreateSound("Sounds/Writing").CreateInstance();
            ...
            // Application Layout
            base.AddComponent(this.mainContainer, (float)(base.Width / 2) - this.mainContainer.Size.X / 2f, (float)(base.Height / 2) - this.mainContainer.Size.Y / 2f);
            base.AddComponent(this.bPlus, (float)base.Width - this.bPlus.Size.X, (float)base.Height - this.bPlus.Size.Y);
            base.AddComponent(this.bMinus, 0f, (float)base.Height - this.bMinus.Size.Y);
