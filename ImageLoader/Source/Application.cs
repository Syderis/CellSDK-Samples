...
namespace ImageLoader
{
    public class Application : MobileApplication
    {
        ...
        public override void Initialize()
        {
            ...
            offset =  Vector2.Zero ;
#endif
            SetBackground(Image.CreateImage("Images/background"), Adjustment.CENTER);
            //Init all lists
            ...
            searchTextArea.BackgroundImage = Image.CreateImage("Images/top_search");
            ...
            AddComponent(searchTextArea, Width/2- searchTextArea.Size.X/2, 0);

            //Search Button
            searchButton = new Button(Image.CreateImage("Images/bt_search"), Image.CreateImage("Images/bt_search_pressed"));            
